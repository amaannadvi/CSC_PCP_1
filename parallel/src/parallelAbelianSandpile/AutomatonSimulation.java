//Copyright M.M.Kuttel 2024 CSC2002S, UCT //additions by S.A.Nadvi NDVSYE003
...
class AutomatonSimulation{
	...
	public static Grid simulationGrid;  //the cellular automaton grid
    ...
    public static void main(String[] args) throws IOException  {
    	...
    	if (args.length!=2) {   //input is the name of the input and output files
			...
			inputFileName = "input/517_by_517_centre_600000.csv";
			outputFileName = "output/output_parallel.png";
    	}else{
